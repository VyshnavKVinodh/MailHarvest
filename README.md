...
- **Styled Excel Export** — Exports to `.xlsx` with branded headers, color-coded validation status, alternating row colors, and auto-filters.
...
Server-Sent Events endpoint for scraping domains.
...
**Events:** `domain-start`, `domain-progress`, `domain-done`, `done`
